...
<div class="col-lg-12">
  <div class="card card-success card-outline">
    <div class="card-header">
      <div class="row">
        <div class="col-sm-<?= (in_array($this->role, ['Reception'])) ? 5 : 7 ?>">
    ...
    <ul class="nav nav-tabs" role="tablist">
      <li class="nav-item col-6">
        <a class="nav-link active change-lead text-center btn btn-outline-primary" data-toggle="pill" href="" role="tab" data-status="0">Inquiries</a>
      </li>
      <li class="nav-item col-6">
        <a class="nav-link change-lead text-center btn btn-outline-primary" data-toggle="pill" href="" role="tab" data-status="1">Archived Inquiries</a>
      </li>
    </ul>
