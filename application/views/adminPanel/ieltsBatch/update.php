      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            'value' => (set_value('batch_name')) ? set_value('batch_name') : $data['batch_name']
            ]) ?>
        ...
        <div class="col-6">
          <div class="form-group">
            ...
            <?= form_dropdown('coach_id', $coach, (set_value('coach_id')) ? set_value('coach_id') : e_id($data['coach_id']),
            [
        ...
        <div class="col-6">
          <div class="form-group">
            ...
            <div class="input-group date" id="from_date" data-target-input="nearest">
              ...
              'value' => (set_value('from_date')) ? set_value('from_date') : date('m/d/Y', strtotime($data['from_date']))
              ]) ?>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <div class="input-group date"  data-target-input="nearest" id="from_time">
                <input type="text" class="form-control datetimepicker-input" data-target="#from_time" data-toggle="datetimepicker" name="from_time" value="<?= (set_value('from_time')) ? set_value('from_time') : date('h:i A', strtotime($data['from_time'])) ?>" />
        ...
        <div class="col-6">
          <div class="form-group">
            ...
            <div class="input-group date" id="to_date" data-target-input="nearest">
              ...
              'value' => (set_value('to_date')) ? set_value('to_date') : date('m/d/Y', strtotime($data['to_date']))
              ]) ?>
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <div class="input-group date"  data-target-input="nearest" id="to_time">
                <input type="text" class="form-control datetimepicker-input" data-target="#to_time" data-toggle="datetimepicker" name="to_time" value="<?= (set_value('to_time')) ? set_value('to_time') : date('h:i A', strtotime($data['to_time'])) ?>" />
